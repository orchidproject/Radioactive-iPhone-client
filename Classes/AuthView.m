...
- (IBAction)signIn {
    ...
    [LQClient single].userInitials=initials;
    [LQClient single].emailAddress=self.emailField.text ;
    
    [[NSNotificationCenter defaultCenter] postNotificationName:LQBeginJoinGameNotification
                                                        object:nil
                                                      userInfo:nil];
